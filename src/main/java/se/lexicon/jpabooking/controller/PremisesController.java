...
public class PremisesController {
    ...
    public ResponseEntity<PremisesDTO> create(@RequestBody PremisesForm form){
    ...
    public ResponseEntity<PremisesDTO> addBooking(@PathVariable("id") String id, @RequestBody BookingForm form){
    ...
    public ResponseEntity<PremisesDTO> update(@PathVariable("id") String id, @RequestBody PremisesForm form){
